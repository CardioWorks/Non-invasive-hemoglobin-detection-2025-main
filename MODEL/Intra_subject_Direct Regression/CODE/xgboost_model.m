function [T_sim1,T_sim2,error1,error2,R1,R2,mae1,mae2,mbe1,mbe2] = xgboost_model(P_train,P_test ,T_train,T_test,M,N)
%%  
...
string = {'xgboostѵ����Ԥ�����Ա�'; ['RMSE=' num2str(error1)]};
...
xlabel('Ԥ������','FontSize',14,'FontName','����')
ylabel('Ԥ����','FontSize',14,'FontName','����')
string = {'xgboost���Լ�Ԥ�����Ա�';['RMSE=' num2str(error2)]};
title(string,'FontSize',14,'FontName','����')
xlim([1, N])
grid
